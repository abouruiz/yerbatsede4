        ...
        <View style={styles.payment_view}>
          ...
          <View style={styles.formArea}>
            ...
            <View style={styles.formItems}>
              ...
              <View style={styles.formItems}>
              <Picker selectedValue= {this.state.operateur} style={styles.Picker}  onValueChange = {this.updateOperator}>
                <Picker.Item label="Orange Money" color="#fc7e02" value="Orange Money"></Picker.Item>
                <Picker.Item label="MTN Money" color="#ecfb02" value="MTN Money"></Picker.Item>    
              </Picker>
              </View>
