...
export default class Payment extends Component {
    ...
    InsertRecord = () => {
        ...
        var Data = {
            ...
            montant_transfert: this.props.navigation.state.params.montant_transfert + "€",
        ...
        fetch("https://yerbatsedeapis.000webhostapp.com/insert2.php", {
            method: 'POST',
            mode: 'no-cors',
            headers: {
                'Accept': 'application/json',
                ...
                <ScrollView>
                    <View style={styles.halfcontainer2}>
                        <View style={styles.adress_network}>
                            ...
                            <TouchableOpacity style={styles.copybutton} onPress={() => this.copytext(IBAN)}>
                                <Feather
                                    name="copy"
                                    color="#ffffff"
                                    size={20}
                            ...
                            <TouchableOpacity style={styles.copybutton} onPress={() => this.copytext(banque)}>
                                <Feather
                                    name="copy"
                                    color="#ffffff"
                                    size={20}
                            ...
                            <TouchableOpacity style={styles.copybutton} onPress={() => this.copytext(reference)}>
                                <Feather
                                    name="copy"
                                    color="#ffffff"
                                    size={20}
                            ...
                            <TouchableOpacity style={styles.copybutton} onPress={() => this.copytext(nom_compte)}>
                                <Feather
                                    name="copy"
                                    color="#ffffff"
                                    size={20}
                            ...
                            <View style={styles.infobox}>
                                ...
                                <View style={[{
                                    ...
                                    <Text style={[styles.text2, { marginBottom: 10, marginTop: 6, color: '#ffffff' }]}>
                                        {this.props.navigation.state.params.montant_transfert} €
                                    </Text>
                                    <Text style={[styles.text2, { marginBottom: 10, marginTop: 6, color: '#ffffff' }]}>
                        ...
                        <View style={styles.notification2}>
                            <Text style={styles.text}>
                                Lorsque vous faites le transfert de votre banque
                            </Text>
                        </View>
                        <View style={styles.notification2}>
                            <Text style={styles.text}>
                                vers la notre, mettez comme motif ou raison du transfert
                            </Text>
                        </View>
                        <View style={styles.notification2}>
                            <Text style={styles.text}>
                                votre Nom et prénom sinon votre
                            </Text>
                        </View>
                        <View style={styles.notification2}>
                            <Text style={styles.text}>
                                transfert ne pourra être attribué
                            </Text>
                        </View>
                        <View style={styles.notification2}>
                            <Text style={styles.text}>
